...
public class NavyaBaseLite {
	// This can be changed to whatever you like
	static String prompt = "navyaSql> ";
	...
	public static void splashScreen() {
		System.out.println(line("*",80));
		System.out.println("Welcome to NavyaBaseLite"); // Display the string.
		version();
	...
	public static void version() {
		System.out.println("NavyaBaseLite v1.0\n");
	}
