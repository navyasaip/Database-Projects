...
public class Sql_Connect {
    ...
    String searchDisplay(String isbn,String title, String author, DefaultTableModel model2){
        ...
        try{
            ...
            if(!isbn.isEmpty() && !title.isEmpty() && !author.isEmpty()){
                        ...
                        "%' and B.fullname like '%"+author+"%' and B.title like '%"+title+"%' Group by  B.branch_id, B.isbn;";
            }
            if(!isbn.isEmpty() && title.isEmpty() && author.isEmpty()){
                        q1 +=" where B.isbn like '%"+isbn+
            ...
            if(isbn.isEmpty() && title.isEmpty() && !author.isEmpty()){
                q1 +=" where B.fullname like '%"+author+
                        "%' Group by  B.branch_id, B.isbn;";
            }
            if(isbn.isEmpty() && !title.isEmpty() && author.isEmpty()){
                q1 += " where B.title like '%"+title+"%' Group by  B.branch_id, B.isbn;";
            }
            
            if(!isbn.isEmpty() && !title.isEmpty() && author.isEmpty()){
                        q1 +=" where B.isbn ="+isbn+
                        " and B.title like '%"+title+"%' Group by  B.branch_id, B.isbn;";
            }
            if(!isbn.isEmpty() && title.isEmpty() && !author.isEmpty()){
                    q1 +=" where B.isbn ="+isbn+
                        " and B.fullname like '%"+author+
                        "%' Group by  B.branch_id, B.isbn;";
            }
            if(isbn.isEmpty() && !title.isEmpty() && !author.isEmpty()){
                q1 += " where B.fullname like '%"+author+
