...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search for book by:");
        ...
        jLabel13.setText("All fields are mandatory *");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(161, 161, 161)
                        .addComponent(jLabel23, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE)))
                .addGap(251, 251, 251))
        );
        ...
        jLabel9.setText("SSN * (xxx-xx-xxx)");
        ...
        jLabel11.setText("All fields marked * are mandatory");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        author=jTextField19.getText();
        title=jTextField20.getText();
        //System.out.println(isbn +" "+ author+" "+title+" " );
        
        if(isbn.isEmpty() && author.isEmpty() && title.isEmpty()){
            message="Enter in any one field to search";
        }
        else{
            message = sq.searchDisplay(isbn,title,author,model2);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(isbn.isEmpty() || branch_id.isEmpty() || card_no.isEmpty())
            message = "Fields marked * are mandatory";
        else{
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        if(card_no.isEmpty())
            ...
            message = "Total Amount of Fine is: "+ amt;
        }
            jLabel31.setText(message);
            sq.disConnect();
